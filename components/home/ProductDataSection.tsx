...
const dataSignals = [
  ...
  { title: "Recorrido de consulta", body: "En qué pasos avanzan, abandonan o solicitan cotización.", pattern: [28, 52, 72, 92] },
];
    ...
    <HomeSectionReveal className={styles.dataBackground}>
      <section className={`${styles.section} ${styles.dataSection}`} data-navbar-theme="dark" data-nav-section="soluciones">
        <SectionHeading
          ...
          title="Lo que tu negocio puede aprender."
          description="Una implementación puede registrar elecciones y recorridos para entender mejor el interés por cada producto."
          wrapContent
        />
